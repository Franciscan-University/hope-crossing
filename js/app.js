...
var possibleGems = ['images/rosary-ring-silver.png', 'images/rosary-ring-gold.png', 'images/rosary-ring-diamond.png'];
var highestScore = 0;
...
Helper.getGemScore = function(gemImageString){
    var gemScores = {
        "images/rosary-ring-silver.png": 20,
        "images/rosary-ring-gold.png": 30,
        "images/rosary-ring-.diamond": 50
        }
...
Helper.showHighScore = function(){
    ...
    var URL = encodeURIComponent("http://www.franciscan.edu");
...
Helper.updateScore = function(event){
    if(possibleGems.indexOf(event) > -1){ // if the event string is found in the array of possible gems
        ...
        div.innerHTML = "Decade prayed! Score: " + score;
    ...
    if(event == "died") {
        ...
        newHighScore = false;
        score = 0;
        div.innerHTML = "You got distracted! Score: " + score;

        div.style.backgroundColor = "#8C3B1A";
    ...
    if(score >= 200){
        div.innerHTML = "Amazing! Score: " + score;
...
var Gem = function() {
    ...
    this.x = Helper.returnRandomValue([107, 207, 307]);
    this.y = Helper.returnRandomValue([130, 2015, 300]);
    this.width = 90;
    this.height = 75;   
}
 ...
 */ 
var Enemy = function() {
    this.sprite = 'images/bob-rice.png';
    this.x = 0;
    if(score >= 100){
        this.y = Helper.returnRandomValue([115, 200, 285, 370]); // the y-axis coordinates of the paved tracks enemies can run on 
    } else {
        this.y = Helper.returnRandomValue([115, 200, 285]);
    }
    this.width = 107;
    this.height = 107;
    if(score >= 200){
 ...
 */ 
var Player = function(){
    this.playerIcon = 'images/fr-dave.png';
